...
internal enum Asset {
    ...
    internal enum Colors {
        ...
        internal static let primaryAccentColor = ColorAsset(name: "primaryAccentColor")
        ...
        internal static let terciaryColor = ColorAsset(name: "terciaryColor")
    }
}
...
internal final class ColorAsset {
    ...
    internal private(set) lazy var color: Color = .init(systemColor)
